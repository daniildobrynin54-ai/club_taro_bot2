...
ИСПРАВЛЕНИЕ:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ Убрана зона left_frame, которая захватывала основное изображение карты
✅ Теперь используется только:
   - badge (бейдж с рангом) - 70% веса
   - top_frame (верхняя рамка) - 30% веса
✅ Карты с одинаковым рангом, но разным изображением теперь 
   правильно определяются как одинаковые
"""
import logging
